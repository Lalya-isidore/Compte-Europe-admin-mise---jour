...
@section('title', 'Utilisateurs — Badge Agent')

@section('content')
<div class="mb-4">
    <h2 class="fw-bold h3 mb-1"><i data-lucide="id-card" style="width:28px;height:28px" class="me-2"></i>Badge Agent — Derniers utilisateurs</h2>
    <p class="text-secondary">Les 10 dernières personnes ayant utilisé l'outil Badge Agent.</p>
</div>
