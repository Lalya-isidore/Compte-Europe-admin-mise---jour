        ...
        <div class="bg-white rounded-4 shadow-sm p-4" style="border:1px solid #eee;">
            <div style="margin-bottom:16px;">
                ...
                <button onclick="openAddMethod()"
                        style="background:#e8521a;color:#fff;border:none;cursor:pointer;padding:8px 18px;border-radius:10px;font-weight:700;font-size:.82rem;display:block;width:fit-content;margin:0 auto;text-align:center;">
                    + Ajouter un moyen
                </button>
            </div>
