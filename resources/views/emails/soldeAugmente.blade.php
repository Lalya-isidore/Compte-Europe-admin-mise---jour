...
<head>
    ...
    <title>{{ __('emails.balance_increased_title') }} - {{ __('emails.footer_brand') }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
            ...
            <tr>
                <td align="center">
                    <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;">
                        <tr>
                            <td style="background:linear-gradient(135deg,#10b981 0%,#059669 100%);padding:20px;text-align:center;color:#fff;font-weight:700;">{{ __('emails.balance_increased_heading') }}</td>
                        </tr>
                        <tr>
                            <td style="padding:24px;color:#333;">
                                <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="text-align:center;padding-bottom:12px;"><div style="font-size:48px;line-height:48px;color:#10b981;"><span class="notranslate">📈</span></div></td>
                                    </tr>
                                    <tr>
                                        <td style="font-size:16px;font-weight:600;padding-bottom:12px;">{{ __('emails.greeting', ['name' => $compte->nom . ' ' . $compte->prenom]) }}</td>
                                    </tr>
                                    <tr>
                                        <td style="padding-bottom:12px;color:#555;">{{ __('emails.balance_increased_message') }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                                ...
                                                <tr>
                                                    <td style="padding:8px 0;">
                                                        <table role="presentation" width="100%" cellpadding="4" cellspacing="0" style="border-collapse:collapse;">
                                                            <tr>
                                                                <td style="width:50%;color:#666;"><span class="notranslate">💰</span> {{ __('emails.label_amount_added') }}</td>
                                                                <td style="width:50%;text-align:right;color:#10b981;font-weight:700;">{{ number_format($montant, 2, ',', ' ') . ' ' . $compte->devise }}</td>
                                                            </tr>
                                                            <tr>
