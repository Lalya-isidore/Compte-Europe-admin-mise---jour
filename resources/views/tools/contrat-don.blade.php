                    ...
                    <div class="cp-preview">
                        ...
                        <div class="cp-preview__doc" id="prev-page-2">
                            ...
                            <div class="prev-container" style="padding: 20px 30px; position: relative; z-index: 1;">
                                ...
                                <div class="prev-legal-para" id="prev-p2-para1" style="text-align: justify; font-size: 9.5px; line-height: 1.35; margin-bottom: 5px; font-weight: bold; color: #000;">
                                ...
                                <div class="prev-legal-para" id="prev-p2-donateur-declare" style="text-align: justify; font-size: 9.5px; line-height: 1.35; margin-bottom: 4px; font-weight: bold; color: #000;">Le Donateur déclare et certifie que :</div>
                                <div class="prev-legal-bullet" id="prev-p2-bullet1" style="text-align: justify; font-size: 9.5px; line-height: 1.35; margin-left: 10px; margin-bottom: 3px; font-weight: bold; color: #000;">• Il est l'unique propriétaire des fonds,</div>
                                <div class="prev-legal-bullet" id="prev-p2-bullet2" style="text-align: justify; font-size: 9.5px; line-height: 1.35; margin-left: 10px; margin-bottom: 3px; font-weight: bold; color: #000;">• Il a le droit, le pouvoir et l'autorité pour donner son consentement à cette donation pour son compte ;</div>
                                <div class="prev-legal-bullet" id="prev-p2-bullet3" style="text-align: justify; font-size: 9.5px; line-height: 1.35; margin-left: 10px; margin-bottom: 5px; font-weight: bold; color: #000;">• Selon les informations dont il dispose, les fonds sont dans une banque locale et sont transférables à tout moment vers le compte bancaire du bénéficiaire.</div>

                                <div class="prev-legal-para" style="text-align: justify; font-size: 9.5px; line-height: 1.35; margin-bottom: 4px; font-weight: bold; color: #000;"><span id="prev-p2-senor">M./Mme</span> <strong id="prev-p2-donataire-name-bold">—</strong> :</div>
                                <div class="prev-legal-bullet" id="prev-p2-accept1" style="text-align: justify; font-size: 9.5px; line-height: 1.35; margin-left: 10px; margin-bottom: 3px; font-weight: bold; color: #000;">• Accepte la donation des FONDS et en assume la garde totale, et l'utilisation conformément aux politiques et Lois 77-995 de l'article 4 du 18/12/77 optant pour les cas de Donation ;</div>
                                <div class="prev-legal-bullet" id="prev-p2-accept2" style="text-align: justify; font-size: 9.5px; line-height: 1.35; margin-left: 10px; margin-bottom: 5px; font-weight: bold; color: #000;">• S'engage à utiliser les fonds correctement et à dépenser l'argent légalement.</div>

                                <div class="prev-legal-para" id="prev-p2-notaire-certifie" style="text-align: justify; font-size: 9.5px; line-height: 1.35; margin-bottom: 4px; font-weight: bold; color: #000;">
                                ...
                                <div class="prev-legal-para" id="prev-p2-legal2" style="text-align: justify; font-size: 9.5px; line-height: 1.35; margin-bottom: 4px; font-weight: bold; color: #000;">La donation entre en vigueur à compter de la date de signature par les parties.</div>
                                <div class="prev-legal-para" id="prev-p2-legal3" style="text-align: justify; font-size: 9.5px; line-height: 1.35; margin-bottom: 8px; font-weight: bold; color: #000;">— reconnaît avoir bénéficié des fonds faisant partie de cet acte de donation.</div>
...
.prev-container { padding: 24px 30px 40px; position: relative; z-index: 1; }
...
@media (max-width: 900px) {
    ...
    .cp-btn-generate { font-size: 0.88rem; padding: 12px; border-radius: 0; }
}
