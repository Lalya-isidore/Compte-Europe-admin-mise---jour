...
<head>
    ...
    <style>
        ...
        body { font-family: {!! $lang === 'ro' ? "'DejaVu Serif'" : "'Times New Roman'" !!}, serif; font-size: 10pt; line-height: 1.5; color: #2c3e50; }
        ...
        .party-title { font-weight: bold; text-decoration: underline; margin-bottom: 8px; color: #002B5B; font-size: 10pt; }
        .party-info { background-color: #f8fafc; border: 1px solid #e2e8f0; padding: 10px; font-size: 9pt; border-radius: 4px; min-height: 100px; }
        ...
        .article-title { color: #002B5B; font-weight: bold; font-size: 11pt; border-bottom: 1px solid #cbd5e0; margin-top: 16px; margin-bottom: 8px; padding-bottom: 4px; }
        ...
        .sig-title { font-style: italic; font-size: 8pt; color: #666; margin-top: 4px; }
        @if($isTestGeneration)
    ...
    <table class="header-table" style="border: none; margin-bottom: 20px;">
        <tr>
            <td style="width: 25%; text-align: center; vertical-align: top; padding-top: 10px;">
                <img src="{{ public_path('images/contract/logo-ue-wave.png') }}" alt="UE" style="height: 98px; width: auto; display: block; margin: 0 auto 5px auto;">
            ...
            <td style="width: 50%; text-align: center; vertical-align: middle; padding: 4px 8px;">
                <img src="{{ public_path('images/contract/image.png') }}" alt="" style="height: 88px; width: auto; display: block; margin: 0 auto 4px auto;">
    ...
    <table class="sig-table">
        <tr>
            <td class="sig-cell" style="width: 35%;">
                <div style="font-size: 8pt; color: #333;">{{ $t['l_emprunteur'] }}</div>
            ...
            <td class="sig-cell" style="width: 35%;">
                <div style="font-size: 8pt; color: #333; text-align: right;">{{ $t['fait_a'] }} {{ $preteurPays }}, {{ $t['le'] }} {{ date('d/m/Y') }}</div>
                <div style="font-size: 8pt; color: #333; margin-top: 5px;">{{ $t['preteur_rep'] }}</div>
                <div style="position: relative; margin-top: 10px; text-align: right;">
                    ...
                    <div style="font-weight: bold; font-size: 10pt; margin-top: -18px; position: relative; z-index: 2; text-align: right;">{{ strtoupper($preteurNom) }}</div>
                </div>
