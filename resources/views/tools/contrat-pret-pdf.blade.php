    ...
    <table class="header-table" style="border: none; margin-bottom: 20px;">
        <tr>
            <td style="width: 25%; text-align: center; vertical-align: top; padding-top: 10px;">
                <img src="{{ public_path('images/contract/logo-ue-wave.png') }}" alt="UE" style="height: 97px; width: auto; display: block; margin: 0 auto 5px auto;">
            ...
            <td style="width: 50%; text-align: center; vertical-align: middle; padding: 4px 8px;">
                <img src="{{ public_path('images/contract/image.png') }}" alt="" style="height: 87px; width: auto; display: block; margin: 0 auto 4px auto;">
