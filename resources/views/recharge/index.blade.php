                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card border-secondary h-100 package-card" data-amount="1500" data-credits="1000">
                                <div class="card-body text-center p-4">
                                    ...
                                    <p class="fw-bold fs-3 text-primary mb-3">+ 1 000 Crédits</p>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card h-100 package-card" style="border-color:#f59e0b;" data-amount="3000" data-credits="2000">
                                <div class="card-body text-center p-4">
                                    ...
                                    <p class="fw-bold fs-3 text-primary mb-3">+ 2 000 Crédits</p>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card border-primary h-100 package-card" data-amount="5000" data-credits="5000">
                                <div class="card-body text-center p-4">
                                    ...
                                    <p class="fw-bold fs-3 text-primary mb-3">+ 5 000 Crédits</p>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card border-success h-100 package-card" data-amount="10000" data-credits="15000">
                                <div class="card-body text-center p-4">
                                    ...
                                    <p class="fw-bold fs-3 text-primary mb-1">+ 15 000 Crédits</p>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card border-info h-100 package-card" data-amount="15000" data-credits="25000">
                                <div class="card-body text-center p-4">
                                    ...
                                    <p class="fw-bold fs-3 text-primary mb-1">+ 25 000 Crédits</p>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card border-warning h-100 package-card" data-amount="25000" data-credits="40000">
                                <div class="card-body text-center p-4">
                                    ...
                                    <p class="fw-bold fs-3 text-primary mb-1">+ 40 000 Crédits</p>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card border-danger h-100 package-card" data-amount="50000" data-credits="100000">
                                <div class="card-body text-center p-4">
                                    ...
                                    <p class="fw-bold fs-3 text-primary mb-1">+ 100 000 Crédits</p>
