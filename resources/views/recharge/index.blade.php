                                                ...
                                                <div class="card h-100 cursor-pointer border-primary">
                                                    <div class="card-body text-center p-3 d-flex flex-column align-items-center justify-content-center gap-2">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-center gap-4 flex-wrap">
                                                            <img src="{{ asset('images/WhatsApp Image 2026-06-08 at 21.48.19.jpeg') }}" alt="MTN, Moov, Celtiis" style="max-width:100%;height:55px;object-fit:contain;border-radius:8px;">
                                                        </div>
