...
@php
    $paidTools = [
        ...
        ['label' => 'Lien de Paiement Pro', 'svg' => '<svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 24 24" fill="none" stroke="#1e3a5f" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 8V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-1"/><path d="M16 12a2 2 0 0 1 2-2h3v4h-3a2 2 0 0 1-2-2z" fill="#1e3a5f" stroke="#1e3a5f"/><line x1="3" y1="9" x2="21" y2="9"/></svg>', 'route' => route('payment-claims.index'), 'badge' => 'New'],
