...
<div class="container py-5">
    <div class="coming-soon-card text-center">
        <div class="coming-soon-icon mb-4 bg-danger-subtle text-danger">
            <i class="fas fa-ticket-alt"></i>
        </div>
        <h2 class="fw-bold mb-3">Collecte de code coupon</h2>
        <p class="lead mb-4">Cette fonctionnalité sera disponible prochainement. Suivez nos mises à jour pour être informé.</p>
