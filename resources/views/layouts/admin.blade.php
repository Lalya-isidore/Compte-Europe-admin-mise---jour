...
<body data-support-enabled="{{ auth()->check() ? '1' : '0' }}">
    ...
    <div class="main-content">
        ...
        <div class="top-header">
            ...
            <div class="top-header__actions">
                ...
                @auth
                <button type="button" class="top-header__btn top-header__btn--notif" id="notif-bell-btn-admin" title="Notifications">
                    <i class="ri-notification-3-line"></i>
                    <span id="notif-badge-admin">0</span>
                </button>
                @endauth
    ...
    (function() {
        ...
        var bellBtn = document.getElementById('notif-bell-btn-admin');
        var list    = document.getElementById('notif-list-admin');
        var panelOpen = false;
        ...
        function renderNotifs(notifs) {
            ...
            list.innerHTML = notifs.map(function(n) {
                ...
                return '<div style="padding:10px 14px 10px 14px;border-bottom:1px solid #f3f4f6;background:' + (unread ? '#fffbeb' : '#fff') + ';position:relative;">'
                    + '<button onclick="notifAdminDeleteOne(' + n.id + ')" style="position:absolute;top:6px;right:8px;background:#f3f4f6;border:none;color:#6b7280;font-size:.78rem;cursor:pointer;line-height:1;padding:3px 6px;border-radius:6px;font-weight:700;" onmouseover="this.style.background=\'#fee2e2\';this.style.color=\'#ef4444\'" onmouseout="this.style.background=\'#f3f4f6\';this.style.color=\'#6b7280\'" title="Supprimer">✕</button>'
        ...
        window.notifAdminMarkAllRead = function() {
            fetch(READ_URL, {
                method: 'POST',
        ...
        function openPanel() {
            ...
            fetchNotifs();
            setTimeout(notifAdminMarkAllRead, 800);
        }
