<?php
// Usage: from project root run: php scripts/send_test_email_tr.php
...
echo "Sending test email in Turkish to: $to\n";
$ok = SafeMailService::send($to, $mailable, 'Test Turkish Email', 'tr');
